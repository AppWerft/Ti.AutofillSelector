...
@Kroll.module(name = "Autofillerselector", id = "de.appwerft.autofillerselector", propertyAccessors = { "onResult" })
public class AutofillerselectorModule extends KrollModule {
	...
	public AutofillerselectorModule() {
		super();
	}
