...
#define TAG "AutofillerselectorModule"

using namespace v8;

namespace de {
namespace appwerft {
namespace autofillerselector {


Persistent<FunctionTemplate> AutofillerselectorModule::proxyTemplate;
jclass AutofillerselectorModule::javaClass = NULL;

AutofillerselectorModule::AutofillerselectorModule() : titanium::Proxy()
{
}

void AutofillerselectorModule::bindProxy(Local<Object> exports, Local<Context> context)
{
...
void AutofillerselectorModule::dispose(Isolate* isolate)
{
	LOGD(TAG, "dispose()");
...
Local<FunctionTemplate> AutofillerselectorModule::getProxyTemplate(v8::Isolate* isolate)
{
	...
	LOGD(TAG, "AutofillerselectorModule::getProxyTemplate()");

	javaClass = titanium::JNIUtil::findClass("de/appwerft/autofillerselector/AutofillerselectorModule");
...
Local<FunctionTemplate> AutofillerselectorModule::getProxyTemplate(v8::Local<v8::Context> context)
{
